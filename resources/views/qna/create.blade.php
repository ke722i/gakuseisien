...
<body>
    <main class="content qna-page">
        ...
        <div class="qna-card-list">
            <form action="#" method="POST" enctype="multipart/form-data" class="qna-custom-card qna-form-padding">
                @csrf

                <div class="qna-form-group">
                    <label for="title" class="qna-form-label">タイトル</label>
                    <input type="text" id="title" name="title" class="qna-search-input qna-form-input-align" placeholder="例：学食の発券機は新紙幣に対応していますか？" required>
                </div>

                <div class="qna-form-group">
                    <label for="body" class="qna-form-label">内容（詳細）</label>
                    <textarea id="body" name="body" class="qna-search-input qna-form-input-align qna-form-textarea" rows="6" placeholder="詳しい質問内容や状況を入力してください..." required></textarea>
                </div>
